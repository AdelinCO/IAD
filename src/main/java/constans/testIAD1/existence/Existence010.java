...
import constans.testIAD1.coupling.interaction.Interaction010;
...
public class Existence010 implements Existence {
    ...
    public Result returnResult010(Experiment experience){
        ...
        else if (experience.equals(addOrGetExperience(LABEL_E2)))
            return createOrGetResult(LABEL_R2);
        else
            return createOrGetResult(LABEL_R3);
    }
